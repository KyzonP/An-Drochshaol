...
func _input(event):
	...
	if (event.is_action_pressed("harvest") and destroyable == true and current_phase > 1) or (event.is_action_pressed("action") and farm.currentTool == "Harvest" and destroyable == true and current_phase > 1):
